...
@Component
public class ConvertServiceImplSielMilk extends ConvertServiceBase implements ConvertService {
    ...
    public ConvertServiceImplSielMilk(CrmConfigProperties crmConfigProperties) {
        super();
    ...
    @Override
    @LogExecutionTime(value = "Конвертация v2 " + SIEL_COMPANY_MILK_NAME, unit = LogExecutionTime.TimeUnit.SECONDS)
            ...
            for (; row <= LAST_ROW; ++row) {
                ...
                for (int iRepeat = 0; iRepeat < 2; ++iRepeat) {
                    dataLine = ConvertedListDataClientsV2.init()
                            ...
                            .setColumnCdata(SIEL_COMPANY_MILK_NAME)
