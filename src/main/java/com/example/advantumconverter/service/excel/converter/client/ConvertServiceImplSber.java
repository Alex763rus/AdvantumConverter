...
public class ConvertServiceImplSber extends ConvertServiceBase implements ConvertService {
    ...
    public static final String OOO_ALMA = "ООО \"АЛМА\"";
    ...
    /*
       ...
       - рассчитывается день:
        ...
        Результат:
        - Берется время из 1 столбца, склеивается с полученным днем выше
        - если дата прибытия больше даты убытия то результат минус 1 день
