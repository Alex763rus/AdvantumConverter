...
//  @Valid
  private List<TransportDocumentPositionDto> positions = null;
  ...
  public TransportDocumentDto changeDateTime(OffsetDateTime changeDateTime) {
...
//  @Valid
  ...
  public TransportDocumentDto changedByLogin(String changedByLogin) {
  ...
  **/
  ...
  public TransportDocumentDto changedByUserId(Integer changedByUserId) {
  ...
  **/
  ...
  public TransportDocumentDto comment(String comment) {
  ...
  **/
  ...
  public TransportDocumentDto createDateTime(OffsetDateTime createDateTime) {
...
//  @Valid
  ...
  public TransportDocumentDto date(OffsetDateTime date) {
    this.date = date;
    return this;
  }
...
//  @Valid
  ...
  public TransportDocumentDto id(Long id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TransportDocumentDto number(String number) {
    this.number = number;
    return this;
  }
  ...
  **/
  ...
  public TransportDocumentDto positions(List<TransportDocumentPositionDto> positions) {
...
//  @Valid
  ...
  public List<TransportDocumentPositionDto> getPositions() {
    return positions;
  }

  public void setPositions(List<TransportDocumentPositionDto> positions) {
    this.positions = positions;
  }

  public TransportDocumentDto status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public TransportDocumentDto type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TransportDocumentDto transportDocumentDto = (TransportDocumentDto) o;
    return Objects.equals(this.changeDateTime, transportDocumentDto.changeDateTime) &&
        Objects.equals(this.changedByLogin, transportDocumentDto.changedByLogin) &&
        Objects.equals(this.changedByUserId, transportDocumentDto.changedByUserId) &&
        Objects.equals(this.comment, transportDocumentDto.comment) &&
        Objects.equals(this.createDateTime, transportDocumentDto.createDateTime) &&
        Objects.equals(this.date, transportDocumentDto.date) &&
        Objects.equals(this.id, transportDocumentDto.id) &&
        Objects.equals(this.number, transportDocumentDto.number) &&
        Objects.equals(this.positions, transportDocumentDto.positions) &&
        Objects.equals(this.status, transportDocumentDto.status) &&
        Objects.equals(this.type, transportDocumentDto.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportDocumentDto {\n");
