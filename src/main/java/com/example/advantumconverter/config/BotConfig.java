...
import static com.example.advantumconverter.constant.Constant.Company.COMPANY_NAME_BUSH_AVTOPROM;
...
public class BotConfig {
    ...
    public Security security() {
        ...
        accessList.put(SUPPORT, List.of(COMMAND_DEFAULT, COMMAND_START, COMMAND_CONVERT_BOGORODSK, COMMAND_CONVERT_COFIX, COMMAND_CONVERT_LENTA, COMMAND_CONVERT_SAMOKAT, COMMAND_CONVERT_DOMINOS));
        accessList.put(ADMIN, List.of(COMMAND_DEFAULT, COMMAND_START));
